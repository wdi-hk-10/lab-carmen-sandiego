...
--  1i. Find the maximum number of languages you can use in one country
...
FROM countrylanguage 
WHERE (language = 'English' AND percentage = 0) OR language != 'English'
ORDER BY countrycode, percentage ASC;
